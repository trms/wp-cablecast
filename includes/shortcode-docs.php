...
function cablecast_get_shortcode_docs() {
    return [
        ...
        'cablecast_shows' => [
            ...
            'long_description' => 'Shows a filterable collection of shows with thumbnails. Can filter by category, producer, or series. Supports grid, list, and featured layouts with configurable columns and pagination.',
            'attributes' => [
            ...
            'examples' => [
                ...
                ['title' => 'Featured Layout', 'atts' => ['layout' => 'featured', 'count' => '9']],
        ...
        'cablecast_upcoming_runs' => [
            'name' => 'Upcoming Runs',
            'tag' => 'cablecast_upcoming_runs',
            'description' => 'Display upcoming airings for a show across all channels.',
            'long_description' => 'Shows a list of upcoming scheduled airings for a specific show, displaying the date, time, and channel for each airing. Useful on show detail pages to let viewers know when they can watch. Automatically detects the current show when used on a show page.',
            'attributes' => [
                ['name' => 'id', 'required' => false, 'default' => 'Current post', 'options' => 'Show post ID', 'description' => 'WordPress post ID of the show (auto-detects in show context)'],
                ['name' => 'count', 'required' => false, 'default' => '5', 'options' => 'Any number', 'description' => 'Number of upcoming runs to display'],
                ['name' => 'show_channel', 'required' => false, 'default' => 'true', 'options' => 'true, false', 'description' => 'Show the channel name with link'],
                ['name' => 'show_date', 'required' => false, 'default' => 'true', 'options' => 'true, false', 'description' => 'Show the date and time'],
                ['name' => 'days_ahead', 'required' => false, 'default' => '14', 'options' => 'Any number', 'description' => 'How many days ahead to look for scheduled runs'],
                ['name' => 'class', 'required' => false, 'default' => '', 'options' => 'CSS class name', 'description' => 'Additional CSS class for custom styling'],
            ],
            'examples' => [
                ['title' => 'Basic Usage', 'atts' => ['id' => '{show_id}']],
                ['title' => 'More Results', 'atts' => ['id' => '{show_id}', 'count' => '10', 'days_ahead' => '30']],
                ['title' => 'Channel Only', 'atts' => ['id' => '{show_id}', 'show_date' => 'false']],
            ],
        ],
        'cablecast_categories' => [
            'name' => 'Categories',
            'tag' => 'cablecast_categories',
            'description' => 'Display categories that have shows.',
            'long_description' => 'Shows a cloud, grid, or list of categories that have shows assigned to them. Each category displays its name, show count, and links to the category archive. Categories can be color-coded based on settings.',
            'attributes' => [
                ['name' => 'layout', 'required' => false, 'default' => 'cloud', 'options' => 'cloud, grid, list', 'description' => 'Display layout style'],
                ['name' => 'show_colors', 'required' => false, 'default' => 'true', 'options' => 'true, false', 'description' => 'Apply category colors from settings'],
                ['name' => 'show_counts', 'required' => false, 'default' => 'true', 'options' => 'true, false', 'description' => 'Show number of shows in each category'],
                ['name' => 'count', 'required' => false, 'default' => '0', 'options' => '0 for all', 'description' => 'Maximum number of categories to show'],
                ['name' => 'class', 'required' => false, 'default' => '', 'options' => 'CSS class name', 'description' => 'Additional CSS class for custom styling'],
            ],
            'examples' => [
                ['title' => 'Tag Cloud', 'atts' => ['layout' => 'cloud']],
                ['title' => 'Grid View', 'atts' => ['layout' => 'grid', 'count' => '8']],
                ['title' => 'List View', 'atts' => ['layout' => 'list', 'show_colors' => 'false']],
            ],
        ],
        'cablecast_home' => [
            'name' => 'Home Page',
            ...
            'attributes' => [
                ...
                ['name' => 'schedule_days', 'required' => false, 'default' => '7', 'options' => '1-14', 'description' => 'Number of days in schedule'],
                ['name' => 'show_recent', 'required' => false, 'default' => 'true', 'options' => 'true, false', 'description' => 'Show the recent shows gallery'],
                ['name' => 'recent_count', 'required' => false, 'default' => '12', 'options' => 'Any number', 'description' => 'Number of recent shows to display'],
                ['name' => 'show_browse', 'required' => false, 'default' => 'true', 'options' => 'true, false', 'description' => 'Show the browse section (series, categories, producers)'],
                ['name' => 'class', 'required' => false, 'default' => '', 'options' => 'CSS class name', 'description' => 'Additional CSS class for custom styling'],
            ],
            'examples' => [
                ['title' => 'Full Home Page', 'atts' => []],
                ['title' => 'Schedule Only', 'atts' => ['show_now_playing' => 'false', 'show_recent' => 'false', 'show_browse' => 'false']],
                ['title' => 'Minimal', 'atts' => ['show_schedule' => 'false', 'show_browse' => 'false', 'recent_count' => '8']],
            ],
        ],
    ];
}
